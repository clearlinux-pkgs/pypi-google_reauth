...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707119927
...
cp %{_builddir}/google-reauth-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_reauth/7df059597099bb7dcf25d2a9aedfaf4465f72d8d || :
